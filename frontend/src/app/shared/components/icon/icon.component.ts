...
/**
 * Jednostavna ikona komponenta sa setom inline SVG-ova.
 * Imena ikonā odgovaraju Lucide ikonama (https://lucide.dev).
 * Lako se dodaju nove ikone — samo dopuni `icons` map.
 */
@Component({
  selector: 'app-icon',
  standalone: true,
...
export class IconComponent {
  ...
  private readonly icons: Record<string, string> = {
    ...
    'stairs': `<path d="M20 4v6h-6v6H8v6H2"/>`,
    ...
    'trees': `<path d="M10 10v.2A3 3 0 0 1 8.9 16v0H5v0h0a3 3 0 0 1-1-5.8V10a3 3 0 0 1 6 0Z"/><path d="M7 16v6"/><path d="M13 19v3"/><path d="M12 19h8.3a1 1 0 0 0 .7-1.7L18 14h.3a1 1 0 0 0 .7-1.7L16 9h.2a1 1 0 0 0 .8-1.7L13 3l-1.4 1.5"/>`,
    ...
    'hammer': `<path d="m15 12-8.373 8.373a1 1 0 1 1-3-3L12 9"/><path d="m18 15 4-4"/><path d="m21.5 11.5-1.914-1.914a2 2 0 0 1 0-2.828l.793-.793a2 2 0 0 0 0-2.828l-3-3a2 2 0 0 0-2.828 0l-.793.793a2 2 0 0 1-2.828 0L9.207 1.793a1 1 0 0 0-1.414 0L4.586 5a1 1 0 0 0 0 1.414l1.586 1.586a2 2 0 0 1 0 2.828L4.586 12.5l3.586 3.586L11 13.5a2 2 0 0 1 2.828 0L15.5 15.086a1 1 0 0 0 1.414 0l3.207-3.207a1 1 0 0 0 0-1.414Z" opacity="0"/><path d="m15 12-8.373 8.373a1 1 0 1 1-3-3L12 9"/>`,
